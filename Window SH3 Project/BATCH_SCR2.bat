...
REM ENSURE VAR4 IS NOT ENGLISHNAMES.CFG NAME

set EnglishNamesLoc="!sh3directory!\Dynamic Campaign\Original Backups\EnglishNames.cfg"

findstr /c:"=!var4!" "!EnglishNamesLoc!"
if not errorlevel 1 (

for /f "tokens=1 delims==" %%f in ('findstr /c:"=!var4!" "!EnglishNamesLoc!"') do (
set var4=%%f
)
)


REM ENSURE VAR4 IS NOT GERMANNAMES.CFG NAME

set GermanNamesLoc="!sh3directory!\Dynamic Campaign\Original Backups\GermanNames.cfg"

findstr /c:"=!var4!" "!GermanNamesLoc!"
if not errorlevel 1 (

for /f "tokens=1 delims==" %%f in ('findstr /c:"=!var4!" "!GermanNamesLoc!"') do (
set var4=%%f
)
)


REM ENSURE VAR4 IS NOT FRENCHNAMES.CFG NAME

set FrenchNamesLoc="!sh3directory!\Dynamic Campaign\Original Backups\FrenchNames.cfg"

findstr /c:"=!var4!" "!FrenchNamesLoc!"
if not errorlevel 1 (

for /f "tokens=1 delims==" %%f in ('findstr /c:"=!var4!" "!FrenchNamesLoc!"') do (
set var4=%%f
)
)
...
for /f "delims=" %%M in (PosTime_Campaign_SCR.mis) do (
set forline=%%M
if "%%M" equ "Name=%var6%" (
echo Career=!CareerName!>>"!sh3directory!\Dynamic Campaign\Careers\!CareerName!\ShipSunk_Data.txt"
echo Patrol=!PatrolNumber!>>"!sh3directory!\Dynamic Campaign\Careers\!CareerName!\ShipSunk_Data.txt"
echo SinkDate=!var5!>>"!sh3directory!\Dynamic Campaign\Careers\!CareerName!\ShipSunk_Data.txt"
echo SinkLong=!var2!>>"!sh3directory!\Dynamic Campaign\Careers\!CareerName!\ShipSunk_Data.txt"
echo SinkLat=!var3!>>"!sh3directory!\Dynamic Campaign\Careers\!CareerName!\ShipSunk_Data.txt"
set "found=true"
)
...
if "!found!" EQU "true" (
echo !forline!>> "!sh3directory!\Dynamic Campaign\Careers\!CareerName!\ShipSunk_Data.txt"
)

for /f "tokens=1 delims==" %%N in ("!forline!") do set endcheck=%%N
if "!endcheck!" EQU "NextWP" goto outside

)

:outside
echo.>>"!sh3directory!\Dynamic Campaign\Careers\!CareerName!\ShipSunk_Data.txt"
goto endloop
